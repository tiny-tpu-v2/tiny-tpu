...
SOF_FILE="$STAGING_PROJECT_DIR/fpga/jtag/output_files_jtag/de1_soc_mnist_jtag_top.sof"
FALLBACK_SOF_FILE="$PROJECT_DIR/artifacts/quartus/jtag/de1_soc_mnist_jtag_top.sof"
