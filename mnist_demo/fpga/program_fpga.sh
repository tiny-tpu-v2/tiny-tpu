# ABOUTME: Programs the DE1-SoC MNIST bitstream onto the FPGA over JTAG.
...
SOF_FILE="$STAGING_PROJECT_DIR/fpga/serial/output_files/de1_soc_mnist_serial_top.sof"
FALLBACK_SOF_FILE="$PROJECT_DIR/artifacts/quartus/serial/de1_soc_mnist_serial_top.sof"
