...
from de1_soc_mnist_demo.mnist_tools import build_uart_frame
from de1_soc_mnist_demo.mnist_tools import compute_tile_words
...
from de1_soc_mnist_demo.mnist_tools import unpack_binary_image
